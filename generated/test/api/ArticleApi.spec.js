...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikiQuizApiSpec.ArticleApi();
  });
  ...
  describe('ArticleApi', function() {
    describe('articleGetGet', function() {
      it('should call articleGetGet successfully', function(done) {
        //uncomment below and update the code to test articleGetGet
        //instance.articleGetGet(function(error) {
